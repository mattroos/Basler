...
//            camera.PixelFormat.SetValue(PixelFormat_Mono8);   // Not writable. --MJR
//            camera.PixelFormat.SetValue(EnumEntry_PixelFormat_Mono8);   // Not writable. --MJR
//            camera.PixelFormat.SetValue(Mono8);   // Not writable. --MJR
            PixelFormatEnums e = camera.PixelFormat.GetValue();
            cout << "PixelFormat: " << camera.PixelFormat.GetValue() << endl;
