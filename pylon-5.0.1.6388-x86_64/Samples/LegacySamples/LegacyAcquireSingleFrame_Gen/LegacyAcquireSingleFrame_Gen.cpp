...
/*
    ...
    Basler strongly recommends reading the Migration topic in the pylon C++ API documentation
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Camera Link devices cannot grab in pylon, so we cannot use them in this sample.
        ...
        if ( GetSfncVersion(Camera.GetNodeMap()) >= Sfnc_2_0_0)
        {
            ...
            // C++ API documentation that gets installed with pylon. The topic contains a list of features covered by
        ...
        const CIntegerPtr PayloadSize = Control.GetNode("PayloadSize");
